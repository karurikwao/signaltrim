...
# default to cp1252 and may crash before users see the real error.
...
def print_usage():
    print("Usage: signaltrim <filepath>")
...
def main():
    ...
    print("Starting signaltrim compression...\n")
