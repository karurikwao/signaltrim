...
- [Installation Matrix](Installation-Matrix.md)
- [FAQ](FAQ.md)

## Product

- [Concepts and Modes](Concepts-and-Modes.md)
- [Architecture](Architecture.md)
- [Agent Integrations](Agent-Integrations.md)
- [Claude Code Hooks](Claude-Code-Hooks.md)
- [SignalTeam](SignalTeam.md)

## Tools

- [Compression Skill](Compression-Skill.md)
- [MCP Shrink](MCP-Shrink.md)
- [Benchmarks and Evals](Benchmarks-and-Evals.md)
