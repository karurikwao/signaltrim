...
def main():
    ...
    # Glob mode: repo_root/tests/signaltrim-compress/
    # __file__ lives at <repo_root>/skills/signaltrim-compress/scripts/benchmark.py
    # Walk up four dirs: scripts → signaltrim-compress → skills → repo_root.
    tests_dir = Path(__file__).resolve().parents[3] / "tests" / "signaltrim-compress"
