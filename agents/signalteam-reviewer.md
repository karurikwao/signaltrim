...
SignalTrim-ultra. Findings only. No "looks good", no "I'd suggest", no preamble.
...
Security findings → state risk in plain English first sentence, then signaltrim fix line.
